...
import com.flysoft.fretcorridor.dto.AuthDto;
...
public class AuthService {
    ...
    public AuthDto.LoginResponse login(AuthDto.LoginRequest request) {
        ...
        System.out.println("PIN reçu : " + request.getCodePin());
        System.out.println("Hash BD : " + utilisateur.getCodePin());
        System.out.println("Match = " + passwordEncoder.matches(
                request.getCodePin(),
                utilisateur.getCodePin()));
    ...
    // ── CONFIG TENANT (à enrichir depuis la base plus tard) ──
    private AuthDto.ConfigTenant getConfigTenant(String tenantId) {
        return switch (tenantId) {
            case "BGFT_CM" -> AuthDto.ConfigTenant.builder()
                    .tenantId("BGFT_CM")
                    .nomBureau("BGFT Cameroun")
                    .langue("fr")
                    .devise("FCFA")
                    .axesDisponibles(new String[]{"Douala-NDjamena", "Epine-Nord", "Douala-Yaounde"})
                    .build();
            case "BNFT_TD" -> AuthDto.ConfigTenant.builder()
                    .tenantId("BNFT_TD")
                    .nomBureau("BNFT Tchad")
                    .langue("fr")
                    .devise("FCFA")
                    .axesDisponibles(new String[]{"NDjamena-FortLamy"})
                    .build();
            case "BARC_RCA" -> AuthDto.ConfigTenant.builder()
                    .tenantId("BARC_RCA")
                    .nomBureau("BARC RCA")
                    .langue("fr")
                    .devise("FCFA")
                    .axesDisponibles(new String[]{"Bangui-Bertoua"})
                    .build();
            default -> AuthDto.ConfigTenant.builder()
                    .tenantId(tenantId)
                    .nomBureau("Bureau inconnu")
                    .langue("fr")
                    .devise("FCFA")
                    .axesDisponibles(new String[]{})
                    .build();
        };
    }
}
